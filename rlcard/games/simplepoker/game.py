...
from rlcard.games.simplepoker import Dealer
from rlcard.games.simplepoker import Player, PlayerStatus
from rlcard.games.simplepoker import Judger
from rlcard.games.simplepoker import Round


class SimplePokerGame:
    def __init__(self, allow_step_back=False, num_players=2):
        """Initialize the class simple poker game"""
    ...
    def init_game(self):
        """
        Initialize the game of simple poker, basically a very simplified limit texas holdem

        This version supports two-player poker
