...
from rlcard.games.simplepoker import Game

DEFAULT_GAME_CONFIG = {
        'game_num_players': 2,
        }

class SimplePokerEnv(Env):
    ''' Simple Poker Environment
    '''

    def __init__(self, config):
        ''' Initialize the SimplePoker environment
        '''
        self.name = 'simple-poker'
        ...
        with open(os.path.join(rlcard.__path__[0], 'games/simplepoker/card2index.json'), 'r') as file:
