...
class PolicyIterator():
    ...
    def policyIteration(self, player_id = 0, gamma = 1.0, epsilon = 1e-10):
        ...
        while True:
            ...
            V = self.policy_evaluation(player_id, gamma, epsilon)   #evaluate latest policy --> you receive its converged value function
            self.policy[player_id] = self.policy_improvement(player_id, V, gamma)          #get a better policy using the value function of the previous one just calculated 
